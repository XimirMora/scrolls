...
\begin{document}
    ...
    \begin{frame}[plain]{Introduzione}
        ...
        \begin{itemize}
            \frag{1-}{grande mole di dati genomici}
            \frag{2-}{necessità di poter prevedere la funzione delle sequenze}
    ...
    \begin{frame}[plain]{Introduzione}
        ...
        \end{itemize}
        \uncover<3->{Sono presentate delle tecniche per poter prevedere queste sequenze attraverso
